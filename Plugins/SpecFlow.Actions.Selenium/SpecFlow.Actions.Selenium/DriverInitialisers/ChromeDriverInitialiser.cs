...
namespace SpecFlow.Actions.Selenium
{
    public class ChromeDriverInitialiser : IDriverInitialiser
    {
        ...
        public ChromeDriverInitialiser(IDriverFactory driverFactory, IWebDriverOptionsFactory webDriverOptionsFactory, ISeleniumConfiguration seleniumConfiguration)
        {
        ...
        {
            var options = _webDriverOptionsFactory.GetChromeOptions(_seleniumConfiguration.Capabilities,
                _seleniumConfiguration.Arguments);

             return _driverFactory.GetChromeDriver(options);
        }
    }
}