...
namespace SpecFlow.Actions.Selenium.Extentions
{
    public static class WebElementExtensions
    {
        ...
        {
            webElement.GetSelectElement().SelectByIndex(index);
        }
        ...
        {
            webElement.GetSelectElement().SelectByText(text);
        }
        ...
        {
            webElement.GetSelectElement().SelectByText(value);
        }
        ...
        {
            var selectElement = webElement.GetSelectElement();
