...
namespace Selenium.Targets.Generation
{
    ...
    {
        public readonly SeleniumSpecFlowJsonPart _seleniumSpecFlowJsonPart;

        public UnitTestTargetFeatureGenerator(IUnitTestGeneratorProvider testGeneratorProvider, CodeDomHelper codeDomHelper, SpecFlowConfiguration specFlowConfiguration, IDecoratorRegistry decoratorRegistry, SeleniumSpecFlowJsonPart seleniumSpecFlowJsonPart)
            : base(testGeneratorProvider, codeDomHelper, specFlowConfiguration, decoratorRegistry)
        {
            _seleniumSpecFlowJsonPart = seleniumSpecFlowJsonPart;
